                        ...
                        return <Card style={{ flex: 0 }}>
                            <CardItem>
                                <Left>
                                    ...
                                    <Body>
                                        <Text>Categoria</Text>
                                        <Text note style={styles.list}>{producto.categoria}</Text>
                                    </Body>
                                </Left>
                            </CardItem>
                            <CardItem>
                                <Body>
                                    <Image source={{ uri: producto.imagen }} style={{ height: 150, width: 320, flex: 1 }} />
                            ...
                            <CardItem>
                                <Body>
                                    <Text style={styles.descripcion1}>Contacto</Text>
                                    <Text note style={styles.descripcion}>{producto.contacto}</Text>
                                </Body>
                                <Body>
                                    <Text >Precio</Text>
                                    <Text note style={styles.precio}>$ {producto.precio}</Text>
                                </Body>
                            </CardItem>
                            <CardItem style={styles.botones}>
                                <Body>
...
const styles = StyleSheet.create({
    ...
    image: { width: 250, height: 250, backgroundColor: 'gray', left: 25 },
    descripcion: {
        marginTop: 10,
        left: 10
    }, 
